...
@interface XZHPickerView () <UIPickerViewDelegate , UIPickerViewDataSource>

@property (assign, nonatomic) PickerViewType type;

@property (copy, nonatomic) void (^onPre)(void);
@property (copy, nonatomic) void (^onTouchComplet)(NSString *resultString);
@property (copy, nonatomic) void (^onDismissComplet)(void);
@property (copy, nonatomic) NSString* (^pickedResultStringWithCustomer)(id object);
